...
public class App {
    public static <T> void main(String[] args) throws Exception {
        ...
        llistaIteratorInt = llista.copiaIterable(); // "llistaItaratorInt" és una còpia de la llista. I ara treballem
                                                    // amb ella amb next i hasNext per poder iterar còmodament
        ...
        llistaIterator = llistaCiutada.copiaIterable(); // "llistaItarator" és una còpia de la llistaCiutada. I ara
